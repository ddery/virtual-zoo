...
void Zoo::setCell(int i, int j, char type){
    if (type == 'L'){ zcell[i][j] = new LandHabitat("Tanah"); } else
    if (type == 'W'){ zcell[i][j] = new WaterHabitat(0); } else
    if (type == 'A'){ zcell[i][j] = new AirHabitat(100); } else
    if (type == 'R'){ zcell[i][j] = new Restaurant("Restaurant"); } else
    if (type == 'r'){ zcell[i][j] = new Road("DefaultRoad"); } else
    if (type == 'P'){ zcell[i][j] = new Park("DefaultPark"); }
    if (type == 'E'){ zcell[i][j] = new Entrance(std::__cxx11::string()); } else
    if (type == 'e'){ zcell[i][j] = new Exit(std::__cxx11::string()); }
}
