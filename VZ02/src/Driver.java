...
class Driver {
    ...
    /**
     * Display the logo to the monitor
     * <p>
     */
    public void logo() {
    ...
    /**
     * display the info of the zoo
     * <p>
     * display list of animal in each cage
     */
    public void zooInfo() {
    ...
    /**
     * display the tour journey
     * <p>
     * interact with the animal when the animal is around the journey
     */
    public void tourZoo() {
        animalMove();
        wow.tour();
    ...
    /**
     * getter total animal in zoo
     * <p>
     * return total of the animal
     */
    ...
    /**
     * getter the food needed
     * <p>
     * return total food needed
     * @param type = define dietType of animal
     */
